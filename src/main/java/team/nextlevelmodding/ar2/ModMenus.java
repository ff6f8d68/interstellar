...
public class ModMenus {
    ...
    public static final RegistryObject<MenuType<GuinuclearengineMenu>> GUINUCLEARENGINE = REGISTRY.register("guinuclearengine", () -> IForgeMenuType.create(GuinuclearengineMenu::new));
}
