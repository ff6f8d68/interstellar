...
public class GuinuclearengineScreen extends AbstractContainerScreen<GuinuclearengineMenu> {
    private final static HashMap<String, Object> guistate = GuinuclearengineMenu.guistate;
    private final Level world;
    private final int x, y, z;
    private final Player entity;

    public GuinuclearengineScreen(GuinuclearengineMenu container, Inventory inventory, Component text) {
