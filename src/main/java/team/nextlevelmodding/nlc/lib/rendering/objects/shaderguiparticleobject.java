...
/**
 * Represents a shader-based GUI particle rendered on the screen.
 * Stores screen position, shader ID, velocity, size, alpha, and lifetime.
 * Rendering will be handled by a future GUI shader particle renderer.
 */
public class shaderguiparticleobject {

    private final String shaderId;     // Shader identifier
    ...
    /**
     * Creates a new shader-based GUI particle at a screen position.
     *
     * @param shaderId Identifier for the shader effect
     * @param x Screen X coordinate
     * @param y Screen Y coordinate
     */
    public shaderguiparticleobject(String shaderId, double x, double y) {
